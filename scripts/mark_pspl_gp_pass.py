#!/usr/bin/env python3
"""Mark PSPL GP old-vs-jax pairs as jax_only + parity + grad pass."""
...
from model_old_vs_jax_fixtures import pspl_gp_pairs  # noqa: E402

STATUS_JSON = REPO / "docs" / "jax_migration_status.json"


def main() -> int:
    pairs = set(pspl_gp_pairs())
    ...
    print(f"marked {marked} PSPL GP pairs; total_done={data['summary']['total_done']}")
    return 0
