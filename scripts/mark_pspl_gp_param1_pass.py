#!/usr/bin/env python3
"""Mark PSPL GP Param1 old-vs-jax pairs as jax_only + parity + grad pass."""
...
from model_old_vs_jax_fixtures import pspl_gp_param1_pairs  # noqa: E402

STATUS_JSON = REPO / "docs" / "jax_migration_status.json"


def main() -> int:
    pairs = set(pspl_gp_param1_pairs())
    ...
    print(f"marked {marked} PSPL GP Param1 pairs; total_done={data['summary']['total_done']}")
    return 0
