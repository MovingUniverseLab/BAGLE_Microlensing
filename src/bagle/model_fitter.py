...
class MicrolensSolver(Solver):
    ...
    default_priors = {
        ...
        'q': ('make_gen', 0.001, 1),
        'q_12': ('make_gen', 0.001, 1),
        'q_13': ('make_gen', 0.001, 1),
        'alpha': ('make_gen', 0, 360),
        'psi': ('make_gen', 0, 360),
        'phi': ('make_gen', 0, 360),
        'phi_muRel': ('make_gen', 0, 360),
        'sep': ('make_gen', 1e-4, 2e-2),
        'sep_12': ('make_gen', 1e-4, 2e-2),
        'sep_23': ('make_gen', 1e-4, 2e-2),
        ...
        'p': ('make_gen', 0, 10000),
        'tp': ('make_gen', 0, 10000),
        'tp_12': ('make_gen', 0, 10000),
        'tp_23': ('make_gen', 0, 10000),
        'aleph': ('make_gen', 1, 10),
        ...
        'a_12': ('make_gen', 1e-4, 2e-2),
        'a_23': ('make_gen', 1e-4, 2e-2),
